...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let api_routes = Router::new()
        ...
        .route("/articles/{id}", get(handlers::get_articles_id))
        .route("/cities/{id}", get(handlers::get_cities_id))
        .route("/deals/{id}", get(handlers::get_deals_id))
        .route("/photos/{id}", get(handlers::get_photos_id))
        .route("/shops/{id}", get(handlers::get_shops_id))
        .route("/users/{id}", get(handlers::get_users_id))
        .route("/users", post(handlers::post_users))
        .route("/deals", post(handlers::post_deals))
